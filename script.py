...
os.system("sudo docker exec -d app1 exit")
os.system("sudo docker exec -d app1 sudo docker start app1")
...
os.system("sudo docker exec -d app2 exit")
...
os.system("sudo docker exec -d app3 exit")
